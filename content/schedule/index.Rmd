...
class_year <- "2021"
base_url <- "https://evalf21.classes.andrewheiss.com/"
...
- [**Content**](/content/) (<i class="fas fa-book-reader"></i>): This page contains the readings, slides, and recorded lectures for the week. Read and watch these **before** our in-person class.
...
- [**Assignment**](/assignment/) (<i class="fas fa-pencil-ruler"></i>): This page contains the instructions for each assignment. Weekly reports are due by *noon* on the day of class. Other assignments are due by *11:59 PM* on the day they're listed.
